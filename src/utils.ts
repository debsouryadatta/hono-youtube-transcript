...
export const getYoutubeClient = (youtube_api_key) => {
 ...
 */
async function getDefaultSubtitleLanguage(videoId, youtubeClient) {
...
export async function main(videoId, youtubeClient) {
  try {
